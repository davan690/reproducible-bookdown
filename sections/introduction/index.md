...
You are welcome to contribute to the original guide (fix typos, add to the [reference list](https://github.com/ropensci/reproducibility-guide/blob/gh-pages/sections/references/index.md), etc.) by submitting a pull request to its [github repository](https://github.com/ropensci/reproducibility-guide). Or contact me with regard to this extended guide here [https://github.com/davan690/reproducible-guidebook](https://github.com/davan690/reproducible-guidebook).
