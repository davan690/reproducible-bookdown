...
For many years I would run the following command in R to ensure I could find the scripts or data I was looking for. This is something that is not recommended by anyone who is a fluent programmer, but you can also set the working directory from within R:
